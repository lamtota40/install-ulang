...
apt install -y linux-image-generic software-properties-common grub-pc btrfs-progs openssh-server sudo nano zsh bash-completion ifupdown rsync jq lsof curl unzip zip initramfs-tools
